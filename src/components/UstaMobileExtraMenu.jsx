...
import { USTA_EXTRA_MENU_NAV } from "../navConfig";
...
/** Mobile-only slide-out content: Bosh sahifa, Rasmlar, account (no bottom-nav items). */
export default function UstaMobileExtraMenu({
  onNavigate,
  login,
  name,
  onSwitchAccount,
    ...
    <div className="flex h-full min-h-0 flex-col border-r border-slate-200/75 bg-white/92 shadow-soft-md backdrop-blur-xl supports-[backdrop-filter]:bg-white/85">
      <div className="flex shrink-0 items-center gap-3 border-b border-slate-100/90 px-5 py-5">
        ...
        <div className="min-w-0 text-left">
          ...
          <p className="text-xs text-slate-500">Qo‘shimcha menyu</p>
        </div>
      </div>
