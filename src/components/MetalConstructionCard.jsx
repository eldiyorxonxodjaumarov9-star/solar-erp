/**
 * @param {import("../services/metalConstructionService.js").MetalConstruction} construction
 * @param {boolean} selected
 * @param {() => void} onSelect
 */
export default function MetalConstructionCard({ construction, selected, onSelect }) {
  return (
    <button
      type="button"
      onClick={onSelect}
