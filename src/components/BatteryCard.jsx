/**
 * @param {import("../services/batteryService.js").Battery} battery
 * @param {boolean} selected
 * @param {() => void} onSelect
 */
export default function BatteryCard({ battery, selected, onSelect }) {
  return (
    <button
      type="button"
      onClick={onSelect}
    ...
    >
      <div className="relative flex aspect-[4/3] w-full items-center justify-center overflow-hidden rounded-lg bg-neutral-50 p-2">
        <img
          src={battery.image}
          alt={battery.name}
          loading="lazy"
      ...
      <div className="mt-3 flex items-center justify-center gap-2 text-sm font-semibold text-neutral-700">
        ...
        <span>{selected ? "Tanlandi (bekor qilish)" : "Tanlash"}</span>
      </div>
